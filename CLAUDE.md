...
The scheduler implements **heijunka (production leveling) for books**. The
full design is documented in [`SCHEDULING.md`](SCHEDULING.md) — read it
before making any changes to scheduling logic.
